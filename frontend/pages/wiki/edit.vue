<template>
  <div>
    ...
    <div class="container-fluid min-vh-100 p-0">
      ...
      <div class="container">
        <div class="row p-3 mt-5 shadow-lg">
          <div class="col-12 text-right">
            <div class="input-group input-group-sm text-end d-inline-block">
              <button type="submit" class="btn btn-danger px-5 p-3" @click="deleteWiki()"><b>Beitrag löschen</b></button>
            </div>
          </div>
          <div class="col-md-11">
            <div ref="errorMessageHolder" id="errorMessageHolder" hidden>
              <span ref="errorMessage" id="errorMessage"></span>
                ...
                <b class="fs-5">Artikel bearbeiten</b>
              <div class="input-group input-group-sm mb-1">
                <span class="input-group-text">Titel*</span>
                <input ref="title" type="text" class="form-control" name="Titel" id="title" required disabled :value="this.title">
              </div>
              <div class="input-group input-group-sm mb-1">
                <span class="input-group-text">Header URL*</span>
                <input ref="headerURL" type="text" class="form-control" name="HeaderURL" id="HeaderURL" placeholder="https://img.com/abc" required :value="this.headerURL">
              </div>
              ...
              <div class="input-group input-group-sm text-center d-inline-block">
                <button type="submit" class="btn btn-primary px-5 p-3" @click="addWiki"><b>Speichern</b></button>
              </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  mount() {
    for(let element of document.getElementsByClassName("ProseMirror")) element.innerHTML = this.content;
  },
  methods: {
    async deleteWiki() {
        await fetch("./delete",
